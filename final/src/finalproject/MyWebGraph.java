...
public class MyWebGraph {
	...
	public boolean addVertex(String s) {
		if (s==null || this.vertexList.containsKey(s)) {
			return false;
		}
		else {
	...
	public boolean addEdge(String s, String t) {
		if (!this.vertexList.containsKey(s)||!this.vertexList.containsKey(t)) {
			return false;
		}
		else {
			return this.vertexList.get(s).addEdge(t);
		}
	}
    ...
    public ArrayList<String> getVertices() {
    	...
    	for (String url:this.vertexList.keySet()) {
    		returnArr.add(url);
    	}
    	return returnArr;
    } 
    ...
    public ArrayList<String> getEdgesInto(String v) {
    	ArrayList<String> urls = this.getVertices();
    	ArrayList<String> returnArr = new ArrayList<String>();
    	for (String url:urls) {
    		if (this.vertexList.get(url).containsEdge(v)) {
    			returnArr.add(url);
    		}
    	}
    	return returnArr;
